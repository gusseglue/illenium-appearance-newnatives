...
`, po = {
    ...
    const [e, t] = b.exports.useState(), [n, r] = b.exports.useState(), [i, o] = b.exports.useState(), [a, l] = b.exports.useState(), [s, u] = b.exports.useState(_l), [c, f] = b.exports.useState(Tl), [p, g] = b.exports.useState(ly), [v, x] = b.exports.useState(!1), [S, h] = b.exports.useState(!1), {
        ...
        r(we => {
            const Xe = we && we.components ? we : n,
                an = Xe && Xe.components ? Xe.components : [],
                dn = {
                    ...Xe,
                    components: [...an.filter(Oe => Oe.component_id !== A), ne]
                };
            return dn
        });
        const {
                settings: ye,
                component: Xe
            } = await de.post("appearance_change_component", ne);
        if (ye) {
            const Vt = [...a.components.filter(Oe => Oe.component_id !== A), ye],
                Je = {
                    ...a,
                    components: Vt
                };
        ...
        Xe && r(we => {
            const an = we && we.components ? we : n,
                dn = an && an.components ? an.components : [];
            return {
                ...an,
                components: [...dn.filter(Oe => Oe.component_id !== A), Xe]
            }
        })
        ...
        r(we => {
            const Xe = we && we.props ? we : n,
                an = Xe && Xe.props ? Xe.props : [],
                dn = {
                    ...Xe,
                    props: [...an.filter(Oe => Oe.prop_id !== A), ne]
                };
            return dn
        });
        const {
                settings: ye,
                prop: Xe
            } = await de.post("appearance_change_prop", ne);
        if (ye) {
            const Vt = [...a.props.filter(Oe => Oe.prop_id !== A), ye],
                Je = {
                    ...a,
                    props: Vt
                };
        ...
        Xe && r(we => {
            const an = we && we.props ? we : n,
                dn = an && an.props ? an.props : [];
            return {
                ...an,
                props: [...dn.filter(Oe => Oe.prop_id !== A), Xe]
            }
        })
